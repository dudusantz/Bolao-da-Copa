...
public class EmailService {
    ...
    public void enviarEmailRecuperacao(String emailDestino, String nomeUsuario, String linkRedefinicao) {
        try {
            ...
            helper.setSubject("Redefinição de Senha - Bolão Time Lion"); // NOME ALTERADO AQUI
            ...
            String htmlContent = "<div style=\"font-family: 'Poppins', sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px;\">" +
                    ...
                    "<p style=\"color: #475569; font-size: 1rem; line-height: 1.6;\">Recebemos uma solicitação para redefinir a senha da sua conta no Bolão Time Lion. Se não foi você, ignore este e-mail.</p>" + // NOME ALTERADO AQUI
